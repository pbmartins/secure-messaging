...
class Client:
    ...
    def choose_cipher_spec():
        suites = [
            ...
            "EECDH-AES192_CFB-RSA2048_OAEP-RSA2048_PSS_SHA256_PKCS1v15_SHA256-HMAC-SHA256",
            ...
            "EECDH-AES192_CTR-RSA2048_OAEP-RSA2048_PSS_SHA256_PKCS1v15_SHA256-HMAC-SHA256",
